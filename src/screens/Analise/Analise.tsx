          ...
          <Collapse ghost>
            ...
            >
              <div className={s.tip}>
                ...
                362880 вариантов перестановок номиналов, против 371 993 326 789 901 217 467 999 448 150 835 200 000 000
                вариантов раскладов, поэтому в автоматическом режиме нет гарантии, что получится найти идеальный расклад
                и нужно будет на основе своей интуиции поменять карты местами. В секции &quot;Расклад&quot;, в режиме
