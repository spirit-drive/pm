        ...
        <Collapse defaultActiveKey="1" ghost>
          ...
          >
            <div className={s.tip}>
              ...
              цепочку, с необходимыми гексаграммами, самобалансировкой, энергопотенциалом балансировки. Выбираете список
              гекс, которые вас устроят, а позже гексаграммы можно менять местами. Подробнее как работать смотрите в
              каждой секции.
            </div>
          </Collapse.Panel>
        </Collapse>
          ...
          <Collapse ghost>
            ...
            >
              <div className={s.tip}>
                ...
                будет на основе своей интуиции поменять карты местами в секции &quot;Расклад&quot;, в режиме &quot;Обмен
                карт индивидуально&quot; выберите карты, подсвеченные красным, что создаст новые 362880 вариантов
                перестановок
              </div>
